...
function verDrop()// desuso, la utilizaba cuando tenia el boton con los drops
{
...
function retornarText(filas)
{
    let arr = Array();
    filas.forEach(element =>{
        let i = element.childNodes;
        i.forEach(childs=>{
            arr.push(childs.textContent);
        })
    });
    return arr;
}
...
export {tratarDatos,armarTabla,armarPropiedadDesdeForm,limpiarTabla,limpiarTablaDinamica,porDefault,
    ...
    verSelect,retornarFilas,retornarText,esconderFila,
